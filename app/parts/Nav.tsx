...
function Nav() {
  return (
    <div className='flex flex-row justify-between items-baseline px-8 lg:px-14 pt-8 lg:pt-16 pb-6 text-slate-600 bg-transparent'>
      ...
      <div id="nav-contact  " className='text-md font-light'>
        ...
        <a href="#" className='hidden md:flex flex-row justify-center items-center gap-2 py-3 px-6 transition duration-300'>About</a>
          <a href="#" className='flex flex-row justify-center items-center gap-2 py-3 px-6 border rounded-full'>
