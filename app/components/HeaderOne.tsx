...
function HeaderOne() {
  return (
    <div className='flex flex-row justify-between items-baseline pb-6 text-slate-60'>

      <div id="logo">
        <p className='text-xl lg:text-2xl font-extrabold tracking-tight text-orange-200'>music.catholic.au</p>
      </div>
